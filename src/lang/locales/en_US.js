...
module.exports = {
  ...
  'menu.izin-camping': 'Izin Camping',
  'menu.tertunda': 'Tertunda',
  'menu.diterima': 'Diterima',
  'menu.ditolak': 'Ditolak',
  'menu.lokasi-wisata': 'Lokasi Wisata',
  'wisata.add-new': 'Tambah',
  'wisata.orderby': 'Urut berdasarkan: ',
  'wisata.edit': 'Edit',
  'wisata.delete': 'Hapus',
  'wisata.add-new-title': 'Tambah Wisata',
  'wisata.name': 'Nama',
  'wisata.category': 'Kategori',
